...
+ (NSString *)getDateStringWithDate:(NSDate *)targetDate dateFormatter:(NSString *)dateFormatter
{
    ...
    NSString *  locationString=[dateformatter stringFromDate:targetDate];
    return locationString;
}
...
+ (NSDate *)getDateFromString:(NSString *)dateString dateFormatter:(NSString *)dateFormatter
{
      ...
      [inputFormatter setDateFormat:dateFormatter];
...
{
    NSDate *newDate = [Common getDateFromString:dateString dateFormatter:inDateFormatter];
    
    return [Common getDateStringWithDate:newDate dateFormatter:outDateFormatter];
}
...
+ (NSInteger )CardIndex:(NSString *)bankName{
    NSArray *bankNumArr = @[
                            ...
                            @"623251", @"628351"];
    NSInteger bindex = 444444;
    for (int i = 0 ; i<[bankNumArr count]; i++) {
        NSString *name = [bankNumArr objectAtIndex:i];
...
+(NSString *)BankNameArray:(NSInteger )bindex{
    NSArray *bankNameArr = @[
                             ...
                             @"中国邮政储蓄银行", @"中国邮政储蓄银行", @"中国邮政储蓄银行", @"中国邮政储蓄银行", @"中国邮政储蓄银行",
                             @"中国邮政储蓄银行", @"中国邮政储蓄银行", @"中国邮政储蓄银行", @"中国邮政储蓄银行", @"中国邮政储蓄银行",
                             @"中国邮政储蓄银行", @"中国邮政储蓄银行", @"中国邮政储蓄银行", @"中国邮政储蓄银行",
                             @"中国邮政储蓄银行", @"中国工商银行", @"中国工商银行", @"中国工商银行", @"中国工商银行",
                             ...
                             @"中国工商银行", @"中国工商银行", @"中国工商银行", @"中国工商银行", @"中国工商银行",
                             @"中国工商银行", @"中国工商银行", @"中国工商银行", @"中国工商银行", @"中国工商银行",
                             @"中国工商银行", @"中国工商银行", @"中国工商银行", @"中国农业银行", @"中国农业银行", @"中国农业银行",
                             ...
                             @"中国农业银行", @"中国农业银行", @"中国农业银行", @"中国农业银行", @"中国农业银行", @"中国农业银行",
                             @"中国农业银行", @"中国农业银行", @"中国农业银行", @"中国农业银行", @"中国农业银行", @"中国农业银行",
                             @"中国农业银行", @"中国农业银行", @"中国农业银行", @"中国银行", @"中国银行", @"中国银行", @"中国银行",
                             ...
                             @"中国银行", @"中国银行", @"中国银行", @"中国银行", @"中国银行", @"中国银行",
                             @"中国银行", @"中国银行", @"中国建设银行", @"中国建设银行", @"中国建设银行", @"中国建设银行", @"中国建设银行",
                             ...
                             @"民生银行", @"民生银行", @"中国招商银行", @"中国招商银行", @"中国招商银行", @"中国招商银行", @"中国招商银行", @"中国招商银行",
                             ...
                             @"中国招商银行", @"中国招商银行", @"中国招商银行", @"中国招商银行", @"中国招商银行", @"中国招商银行", @"中国招商银行",
                             @"中国招商银行", @"中国招商银行", @"中国招商银行", @"中国招商银行", @"中国招商银行",
                             @"中国招商银行", @"中国招商银行", @"中国招商银行", @"中国招商银行", @"中国招商银行",
                             @"中国招商银行", @"兴业银行", @"兴业银行", @"兴业银行", @"兴业银行", @"兴业银行",
                             @"兴业银行", @"兴业银行", @"兴业银行", @"兴业银行", @"兴业银行", @"兴业银行",
                             @"兴业银行", @"兴业银行", @"兴业银行", @"兴业银行", @"兴业银行", @"兴业银行", @"兴业银行",
                             @"兴业银行", @"兴业银行", @"兴业银行", @"兴业银行", @"兴业银行", @"兴业银行", @"兴业银行",
                             @"兴业银行", @"兴业银行", @"兴业银行", @"兴业银行", @"兴业银行", @"兴业银行", @"兴业银行", @"浦东发展银行·浦发JCB金卡",
                             ...
                             @"玉溪市商业银行·红塔卡"];
    NSString *bankName = [bankNameArr objectAtIndex:bindex];
    return bankName;
}
