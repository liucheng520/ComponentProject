...
- (void)commonInit {
    ...
    self.arrowSize = CGSizeMake(20.0, 10.0);
...
//    if(!self.blackCoverView)
//    {
//        CGPoint arrowPoint = [self.containerView convertPoint:self.arrowShowPoint toView:self];
//        self.blackCoverView = [[BlackCoverView alloc] initWithFrame:self.bounds ArrowSize:self.arrowSize arrowPoint:arrowPoint popoverPosition:self.popoverPosition];
//        self.blackCoverView.autoresizingMask =
//        UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
//        //        self.blackCoverView.backgroundColor = [UIColor colorWithWhite:0.0 alpha:0.0];
//    }
